...
- 深色版提示摘要：方形不透明深石墨产品背景；中央双层基座上的单一三跑道桥梁模型，三块空白题牌、一个低矮琥珀地面障碍和一个青色玻璃高空横梁；略俯视 3/4 镜头；明确禁止四向路口、人物、文字、公式、Logo、水印、徽章或多余物件。
- 浅色版编辑约束：严格保持深色版的三跑道几何、镜头、构图、比例、障碍数量、位置和光影关系，仅将背景与主体材质切换为暖象牙/浅石材，同时保留石墨轮廓、琥珀障碍和少量青色玻璃边。
