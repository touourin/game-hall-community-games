...
单人三跑道数学桥面跑酷插件。玩家在跑者抵达题段前，从左、中、右三条跑道中开放的 2–3 条路线里找出唯一成立的等式，并执行对应动作：A/D 左右变道，W 跳过地面障碍，S 下蹲穿过高空障碍。错选或超时立即结束；连续答对 10 题提升一级，共 10 个速度等级。
...
| 值 | 键盘 | 含义 |
| --- | --- | --- |
| `jump` | W / ↑ / 空格 | 跳过中间跑道的地面障碍 |
| `left` | A / ← | 进入左侧分叉 |
| `slide` | S / ↓ | 下蹲穿过中间跑道的高空障碍 |
| `right` | D / → | 进入右侧分叉 |
