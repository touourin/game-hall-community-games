...
- `frontend/GameView.vue`：沉浸牌桌、本人手牌、低牌选行、分数轨、规则面板及出牌/收牌动效。
...
实现采用 Wolfgang Kramer 设计、AMIGO 发布的 `6 nimmt! / Take 5` 基础规则：104 张牌、每人 10 张、四行、每行上限 5 张、低牌自选收行、66 分终局。周年特殊牌、专家选牌变体及其他衍生版本不在本插件范围内。
...
实验台可切换 4–8 人，并分别重放发牌、升序落牌、第六张收牌、低牌选行和低牌收牌场景；用于检查模型配色、真实 DOM 运动路径、窄屏越界与动画层级。
