        ...
        <ol>
          ...
          >
            ...
            <span class="player-name">
              <b>{{ player.name }}</b>
              <small v-if="player.id === game.dealerPlayerId">庄家</small>
              <small v-else-if="game.forfeitedPlayerIds?.includes(player.id)">已退出</small>
